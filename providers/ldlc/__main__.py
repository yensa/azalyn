...
def page(
    ...
    while True:
        ...
        if message and (data := message.get("data")):
            ...
            save_to_object(_id, "ldlc", product_page, collection)
...
def price(
    ...
    url: str | None = obj.get("ldlc")

    if url is None:
        raise ValueError(f"Couldn't find any ldlc url on {object_id=}")
    ...
    save_to_object(object_id, "ldlc_price", price, collection)
